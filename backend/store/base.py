...
Defines the interface that LocalStore (JSON files) implements. The
backtest orchestrators (Preconditioner, Simulator) and the frontend API
call these methods without knowing the storage backend.
