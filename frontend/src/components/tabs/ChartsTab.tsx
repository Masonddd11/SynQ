...
export function ChartsTab({ session, dailyStats, dateRange }: Props) {
  ...
  // DESIGN.md palette — red signal first, then ink grays
  const LINE_COLORS = [
    'var(--color-chart-1)',
    'var(--color-chart-2)',
    'var(--color-chart-3)',
          ...
          <div className="h-[350px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={filteredData}>
                ...
                <XAxis dataKey="date" tick={{ fontSize: 11, fill: 'var(--color-ink-soft)' }} />
            ...
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={filteredData}>
                  <CartesianGrid strokeDasharray="3 3" stroke="var(--color-hairline)" />
                  <XAxis dataKey="date" tick={{ fontSize: 10, fill: 'var(--color-ink-soft)' }} />
                  <YAxis tick={{ fontSize: 11, fill: 'var(--color-ink-soft)' }} reversed />
                  <Tooltip
                    contentStyle={{
                      background: 'var(--color-background)',
                      border: '1px solid var(--color-hairline)',
